...
/**
 * The Missing Statistics Exception class.
 * This allows for an exception to be made when
 * the DBL class does not detect a value for automatic
 * statistics posting.
 */
class MissingStatsException
{
  /** @var mixed */
  public $message;
  ...
  /**
   * Creates a MissingStatsException class.
   *
  ...
  {
    $this->message = "The API could not make a successful connection due to missing value(s). (Check for valid value?)";
